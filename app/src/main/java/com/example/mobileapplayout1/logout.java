    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.mnu_products:
                        startActivity(new Intent(logout.this, ProductsActivity.class));
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.mnu_index:
                        startActivity(new Intent(logout.this, index.class));
                        return true;
                    case R.id.mnu_history:
                        startActivity(new Intent(logout.this, HistoryActivity.class));
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.mnu_setting:
                        Toast.makeText(logout.this,"Setting Here",Toast.LENGTH_SHORT).show();
                        return true;
                }
                return false;
            }
        ...
        reference.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(logout.this,"Lỗi database",Toast.LENGTH_LONG).show();
            }
        });
