...
public class Order {
    ...
    public Order(String custAddress, String custName, String custPhone, String dateOrder, String status, int numProduct, int totalPrice, ArrayList<DetailOrder> listDetailOrder) {
    ...
    public ArrayList<DetailOrder> getListDetailOrder() {
        return listDetailOrder;
    }

    public void setListDetailOrder(ArrayList<DetailOrder> listDetailOrder) {
        this.listDetailOrder = listDetailOrder;
    }
